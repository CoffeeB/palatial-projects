    ...
    t = {
      ...
      3903: (e, t, i) => {
        ...
        (o.t1.defaults.responsive = !0),
          ...
          (o.t1.defaults.elements.line.tension = 0.4),
          ...
          te = (function () {
            ...
            return (
              (e.prototype.show = function () {
                return (
                  X(this.element, this.classNames.activeState),
            ...
            return (
              ...
              (e.prototype.open = function (e, t) {
                X(this.element, this.classNames.openState),
                  ...
                  (this.isOpen = !0),
                  this.shouldFlip(e, t) &&
                    (X(this.element, this.classNames.flippedState),
                    (this.isFlipped = !0));
              }),
            ...
            return (
              ...
              (e.prototype._animateScroll = function (e, t) {
                var i = this,
                  ...
                  s = !1;
                t > 0
                  ? (this._scrollDown(a, 4, e), a < e && (s = !0))
                  : (this._scrollUp(a, 4, e), a > e && (s = !0)),
                  s &&
                    requestAnimationFrame(function () {
        ...
        function De(e) {
          let t = null,
            ...
            s = 1,
            o = null;
          if (Le(e) || we(e)) (a = e), (t = Pe(e)), (i = ze(e));
          else {
            if (!He.call(e, "name")) throw new Error(Te("name"));
            const r = e.name;
            if (((a = r), He.call(e, "weight") && ((s = e.weight), s <= 0)))
              throw new Error(Oe(r));
            ...
            const s = (e, t, o) => {
              if (Fe(e))
                if (t[o]) {
                  const r = e[t[o]];
                  if (!Fe(r)) return;
                  if (o === t.length - 1 && (Le(r) || Se(r) || ke(r)))
                    i.push(Me(r));
                  else if (we(r)) {
                    a = !0;
        ...
        class Ue {
          constructor({
            getFn: e = Re.getFn,
            fieldNormWeight: t = Re.fieldNormWeight,
          } = {}) {
        ...
        function Be(
          e,
          t,
          { getFn: i = Re.getFn, fieldNormWeight: a = Re.fieldNormWeight } = {}
        ) {
        ...
        function Ke(
          ...
          if (t.length > qe)
            throw new Error(`Pattern length exceeds max of ${qe}.`);
          const h = t.length,
            d = e.length,
          ...
          const E = { isMatch: m >= 0, score: Math.max(0.001, b) };
          if (f) {
        ...
        class Ge {
          ...
          searchIn(e) {
            ...
            let c = [],
              ...
              d = !1;
            this.chunks.forEach(
              ({ pattern: t, alphabet: u, startIndex: p }) => {
                const {
                  isMatch: m,
                  score: f,
                  indices: y,
        ...
        class yt {
          constructor(e, t = {}, i) {
            (this.options = Ee(Ee({}, Re), t)),
              this.options.useExtendedSearch,
              (this._keyStore = new Ne(this.options.keys)),
          ...
          search(e, { limit: t = -1 } = {}) {
            ...
            return (
              (function (e, { ignoreFieldNorm: t = Re.ignoreFieldNorm }) {
                e.forEach((e) => {
                  let i = 1;
              ...
              i.forEach(({ v: e, i, n: s }) => {
                ...
                o &&
                  a.push({
                    item: e,
                    idx: i,
                    matches: [{ score: r, value: e, norm: s, indices: n }],
                  });
              }),
              a
            );
              ...
              i = (e, t, a) => {
                ...
                for (let o = 0, r = e.children.length; o < r; o += 1) {
                  const r = e.children[o],
                    n = i(r, t, a);
                  if (n.length) s.push(...n);
                  else if (e.operator === nt) return [];
                }
                return s;
              },
            ...
            return (
              a.forEach(({ $: e, i: a }) => {
                if (Fe(e)) {
                  ...
                  r.length &&
                    (s[a] ||
                      ((s[a] = { idx: a, item: e, matches: [] }), o.push(s[a])),
                    r.forEach(({ matches: e }) => {
                      s[a].matches.push(...e);
                    }));
                }
          ...
          _searchObjectList(e) {
            ...
            return (
              a.forEach(({ $: e, i: a }) => {
                ...
                i.forEach((i, a) => {
                  o.push(
                    ...this._findMatches({ key: i, value: e[a], searcher: t })
                  );
                }),
        ...
        (yt.version = "7.0.0"),
          ...
          (yt.parseIndex = function (
            ...
            const { keys: a, records: s } = e,
              o = new Ue({ getFn: t, fieldNormWeight: i });
        ...
        var vt = (function () {
          ...
          return (
            ...
            (e.prototype.search = function (e) {
              return (
                this._fuse ||
                  (this._fuse = new yt(this._haystack, this._fuseOptions)),
              ...
              i &&
                ...
                ("string" == typeof s
                  ...
                  : "object" != typeof s ||
                    ...
                    (a.customProperties = JSON.stringify(s)));
          },
          bt = function (e, t, i) {
          ...
          _t = {
              ...
              return (
                ...
                i &&
                  ...
                  s
                    ...
                    : r || bt(this._docRoot, this.passedElement.element.id, l),
            ...
            item: function (e, t, i) {
              ...
              if (
                ...
                t.placeholder && (X(m, u), (m.dataset.placeholder = "")),
                ...
                v && y.setAttribute("aria-label", v),
                  (y.dataset.button = ""),
                  s
                    ? m.insertAdjacentElement("afterbegin", y)
                    : m.appendChild(y);
              }
              return m;
            },
            ...
            choice: function (e, t, i, a) {
              ...
              return (
                ...
                t.disabled
                  ...
                  : (X(f, l), (f.dataset.choiceSelectable = "")),
                f
              );
            },
            input: function (e, t) {
              ...
              return (
                ...
                t
                  ...
                  : o || bt(this._docRoot, this.passedElement.element.id, r),
                r
              );
            },
            dropdown: function (e) {
              var t = e.classNames,
                ...
                s = document.createElement("div");
              return (
                X(s, i), X(s, a), s.setAttribute("aria-expanded", "false"), s
              );
            },
            notice: function (e, t, i) {
              ...
              return (
                i === ge &&
                  ((h.dataset.choiceSelectable = ""), (h.dataset.choice = "")),
                h
              );
            },
            option: function (e) {
            ...
            function e(t, i) {
              ...
              (this.config = u(u(u({}, s.allOptions), s.options), i)),
                O.forEach(function (e) {
                  a.config[e] = u(
                    u(u({}, s.allOptions[e]), s.options[e]),
                    i[e]
                  );
                });
              var o = this.config;
              ...
              if (
                ...
                (this._canAddUserChoices =
                  (c && o.addItems) || (p && o.addChoices)),
                "boolean" != typeof o.renderSelectedChoices &&
                  (o.renderSelectedChoices =
                    "always" === o.renderSelectedChoices || h),
                "auto" === o.closeDropdownOnSelect
                  ? (o.closeDropdownOnSelect =
                      c || h || o.singleModeForMultiSelect)
                  : (o.closeDropdownOnSelect = ne(o.closeDropdownOnSelect)),
                o.placeholder &&
                  (o.placeholderValue
                    ? (this._hasNonChoicePlaceholder = !0)
                    : n.dataset.placeholder &&
                      ((this._hasNonChoicePlaceholder = !0),
              ...
              if (
                ...
                (this._baseId = (function (e, t) {
                  var i =
                    e.id ||
                    (e.name && "".concat(e.name, "-").concat(R(2))) ||
                    R(4);
                  return (
                    (i = i.replace(/(:|\.|\[|\]|,)/g, "")),
                    "".concat(t, "-").concat(i)
            ...
            return (
              ...
              (e.prototype.init = function () {
                if (!this.initialised && void 0 === this.initialisedOK) {
                  var e;
                  (this._searcher = ((e = this.config), new vt(e))),
                    this._loadChoices(),
                  ...
                  this._isSelectElement
                    ? (this._store.withTxn(function () {
                        var s = a.passedElement.optionsAsChoices(),
                          o = {};
                        i ||
                          a._store.items.forEach(function (e) {
                            e.id &&
                              e.active &&
                              e.selected &&
                              !e.disabled &&
                    ...
                    d = function (a, s, o) {
                      ...
                      (n = !s && r && n > r ? r : n),
                        ...
                        a.every(function (a, s) {
                          var r =
                            a.choiceEl ||
                            e._templates.choice(t, a, t.itemSelectText, o);
                          return (
                            (a.choiceEl = r),
                            l.appendChild(r),
                        ...
                        s.forEach(function (a) {
                          ...
                          if (s.length) {
                            if (a.label) {
                              var o =
                                a.groupEl ||
                                e._templates.choiceGroup(e.config, a);
                              (a.groupEl = o), o.remove(), l.appendChild(o);
                            }
                            d(
                              s,
                              !0,
                              t.appendGroupInSearch && i ? a.label : void 0
                            );
                          }
                        }))
                      : d(c(o), !1, void 0)),
              ...
              (e.prototype._renderItems = function () {
                var e = this,
                  ...
                  r = function (t) {
                    ...
                    (i && i.parentElement) ||
                      ((i =
                        o(t) || e._templates.item(a, t, a.removeItemButton)),
                      (t.itemEl = i),
                      s.appendChild(i));
                  };
                t.forEach(r);
              ...
              (e.prototype._clearNotice = function () {
                if (this._notice) {
                  var e = this.choiceList.element.querySelector(
                    Y(this.config.classNames.notice)
                  );
                ...
                if (
                  ...
                  if (this._isSelectElement) {
                    ...
                    this._isTextElement &&
                      ...
                      s &&
                      ((i = !1), (a = B(t.uniqueItemText, e)));
                }
                return (
                  i && (a = B(t.addItemText, e)),
              ...
              (e.prototype._searchChoices = function (e) {
                ...
                return (
                  (s && s.type) !== ge &&
                    (a.length
                      ? this._clearNotice()
                      : this._displayNotice(j(this.config.noResultsText), ve)),
              ...
              (e.prototype._stopSearch = function () {
                this._isSearching &&
                  ...
                  (this._isSearching = !1),
                  this._clearNotice(),
                  this._store.dispatch({ type: g, active: !0 }),
                  this.passedElement.triggerEvent(k, {
                    value: "",
                    resultCount: 0,
                  }));
              ...
              (e.prototype._onEnterKey = function (e, t) {
                ...
                if ((e.preventDefault(), s && s.hasAttribute("data-button")))
                  ...
                  var o = this.dropdown.element.querySelector(
                    Y(this.config.classNames.highlightedState)
                  );
                      ...
                      if (this._canAddItems()) {
                        ...
                        this._store.withTxn(function () {
                          if (!(r = i._findAndSelectChoiceByValue(a, !0))) {
                            ...
                            var e = $(a),
                              t =
                                i.config.allowHtmlUserInput || e === a
                                  ? a
                                  : { escaped: e, raw: a };
                            i._addChoice(
                              ce({ value: t, label: t, selected: !0 }, !1),
                              !0,
                              !0
                            ),
                              (r = !0);
                ...
                if (t || this._isSelectOneElement) {
                    ...
                    n =
                      r > 0
                        ? this.dropdown.element.querySelector(
                            "".concat(At, ":last-of-type")
                          )
                        : this.dropdown.element.querySelector(At);
                  else {
                  ...
                  n &&
                    ...
                    (s > 0
                      ...
                      : i.offsetTop >= a.scrollTop) ||
                      this.choiceList.scrollToChildElement(n, r),
                ...
                if (t instanceof HTMLElement) {
                  ...
                  if (t !== this.input.element) {
                    ...
                    a instanceof HTMLElement &&
                      ("button" in a.dataset
                        ? this._handleButtonAction(a)
                        : "item" in a.dataset
                        ? this._handleItemAction(a, e.shiftKey)
                        : "choice" in a.dataset && this._handleChoiceAction(a)),
                      e.preventDefault();
                  }
                }
              }),
              ...
              (e.prototype._onFocus = function (e) {
                ...
                if (t && i.element.contains(t)) {
                  ...
                  this._isTextElement
                    ...
                    ? a && (this.showDropdown(!0), i.addFocusState())
                    : (i.addFocusState(), a && this.showDropdown(!0));
                }
              }),
              ...
              (e.prototype._highlightChoice = function (e) {
                ...
                if (t.length) {
                  ...
                  Array.from(
                    this.dropdown.element.querySelectorAll(Y(a))
                  ).forEach(function (e) {
                    ...
                    this.passedElement.triggerEvent(Z, { el: i }),
                    this.dropdown.isActive &&
              ...
              (e.prototype._addChoice = function (e, t, i) {
                ...
                var a = this.config;
                if (
                  (!this._isSelectElement && a.duplicateItemsAllowed) ||
              ...
              (e.prototype._createElements = function () {
                ...
                (this.containerOuter = new ie({
                  ...
                  (this.choiceList = new se({ element: e.choiceList(t, i) })),
                  (this.itemList = new se({ element: e.itemList(t, i) })),
              ...
              (e.prototype._addPredefinedChoices = function (e, t, i) {
                ...
                e.forEach(function (e) {
                  "choices" in e
                    ? a._isSelectElement && a._addGroup(e, i)
                    : a._addChoice(e, i);
                });
              }),
              (e.prototype._findAndSelectChoiceByValue = function (e, t) {
                ...
                return (
                  !(!a || a.disabled || a.selected) &&
                  (this._addItem(a, !0, t), !0)
                );
              }),
                ...
                return {
                  choice: ({ classNames: t }, i) => {
                    const a = `${t.item} ${t.itemChoice} ${
                      ...
                      n =
                        i.customProperties && i.customProperties.avatarSrc
        ...
        var xt = {
          ...
          resize(e, t, i, a) {
            let s = {
              ...
              o = e.width / e.height;
            null == t && null == i
              ? ((t = s.srcWidth), (i = s.srcHeight))
              : null == t
              ? (t = i * o)
              : null == i && (i = t / o);
            let r =
              (t = Math.min(t, s.srcWidth)) / (i = Math.min(i, s.srcHeight));
            if (s.srcWidth > t || s.srcHeight > i)
              if ("crop" === a)
                o > r
                  ? ((s.srcHeight = e.height), (s.srcWidth = s.srcHeight * r))
                  : ((s.srcWidth = e.width), (s.srcHeight = s.srcWidth / r));
              else {
                if ("contain" !== a)
          ...
          addedfile(e) {
            if (
              ...
              for (var t of ((e.previewElement = Ft.createElement(
              ...
              this.options.addRemoveLinks &&
                ((e._removeLink = Ft.createElement(
              ...
              let i = (t) => (
                t.preventDefault(),
                t.stopPropagation(),
                e.status === Ft.UPLOADING
                  ? Ft.confirm(this.options.dictCancelUploadConfirmation, () =>
                      this.removeFile(e)
                    )
                  : this.options.dictRemoveFileConfirmation
                  ? Ft.confirm(this.options.dictRemoveFileConfirmation, () =>
                      this.removeFile(e)
                    )
                  : this.removeFile(e)
              );
        ...
        class Ft extends kt {
          ...
          getActiveFiles() {
            return this.files
              .filter(
                (e) => e.status === Ft.UPLOADING || e.status === Ft.QUEUED
              )
              .map((e) => e);
          }
          init() {
          ...
          destroy() {
            return (
              ...
              Ft.instances.splice(Ft.instances.indexOf(this), 1)
            );
          }
          ...
          _addFilesFromItems(e) {
            return (() => {
              ...
              for (let a of e) {
                var i;
                null != a.webkitGetAsEntry && (i = a.webkitGetAsEntry())
                  ? i.isFile
                    ? t.push(this.addFile(a.getAsFile()))
                    : i.isDirectory
          ...
          accept(e, t) {
            ...
            e.size > 1048576 * this.options.maxFilesize
              ...
              : Ft.isValidFile(e, this.options.acceptedFiles)
              ? null != this.options.maxFiles &&
                this.getAcceptedFiles().length >= this.options.maxFiles
                ? (t(
          ...
          enqueueFile(e) {
            if (e.status !== Ft.ADDED || !0 !== e.accepted)
              throw new Error(
                "This file can't be queued because it has already been processed or was rejected."
              );
            if (((e.status = Ft.QUEUED), this.options.autoProcessQueue))
          ...
          removeFile(e) {
            if (
              (e.status === Ft.UPLOADING && this.cancelUpload(e),
              (this.files = It(this.files, e)),
          ...
          removeAllFiles(e) {
            ...
            for (let t of this.files.slice())
              (t.status !== Ft.UPLOADING || e) && this.removeFile(t);
            return null;
          }
              ...
              if (null == i) return s(e);
              {
                ...
                return (
                  ("image/jpeg" !== t && "image/jpg" !== t) ||
                    (a = Ot.restore(e.dataURL, a)),
                  s(Ft.dataURItoBlob(a))
                );
              }
            });
          }
            ...
            (r.onload = () => {
              (e.dataURL = r.result),
                "image/svg+xml" !== e.type
                  ? this.createThumbnailFromUrl(e, t, i, a, s, o)
                  : null != o && o(r.result);
            }),
              r.readAsDataURL(e);
          }
          ...
          createThumbnailFromUrl(e, t, i, a, s, o, r) {
            ...
            return (
              ...
              (s =
                "from-image" !=
                  getComputedStyle(document.body).imageOrientation && s),
              (n.onload = () => {
                let r = (e) => e(1);
                return (
                  ...
                  r((s) => {
                    ...
                    switch (
                      ...
                      s > 4 &&
                        ((l.width = r.trgHeight), (l.height = r.trgWidth)),
                      s)
                    ) {
                      case 2:
          ...
          cancelUpload(e) {
            if (e.status === Ft.UPLOADING) {
              ...
              (e.status !== Ft.ADDED && e.status !== Ft.QUEUED) ||
                ((e.status = Ft.CANCELED),
          ...
          uploadFiles(e) {
            this._transformFiles(e, (t) => {
              ...
              if (e[0].upload.chunked) {
                ...
                if (
                  ((i.upload.finishedChunkUpload = (t, a) => {
                    let s = !0;
                    (t.status = Ft.SUCCESS),
                      (t.dataBlock = null),
                  ...
                  for (let e = 0; e < i.upload.totalChunkCount; e++) o();
                else o();
              } else {
                let i = [];
          ...
          _uploadData(e, t) {
            ...
            this.options.binaryBody && (o["Content-Type"] = e[0].type),
              this.options.headers && (0, Lt.A)(o, this.options.headers);
            for (let e in o) {
              let t = o[e];
            ...
            if (this.options.binaryBody) {
              ...
              if (this.options.params) {
                ...
                for (let e in t) {
                  let i = t[e];
                  if (Array.isArray(i))
                    for (let t = 0; t < i.length; t++) a.append(e, i[t]);
                  else a.append(e, i);
                }
              }
              for (let t of e) this.emit("sending", t, i, a);
              this.options.uploadMultiple &&
                this.emit("sendingmultiple", e, i, a),
          ...
          _addFormElementData(e) {
            if ("FORM" === this.element.tagName)
              for (let t of this.element.querySelectorAll(
                ...
                if ((a && (a = a.toLowerCase()), null != i))
                  if ("SELECT" === t.tagName && t.hasAttribute("multiple"))
                    for (let a of t.options) a.selected && e.append(i, a.value);
                  else
                    (!a || ("checkbox" !== a && "radio" !== a) || t.checked) &&
                      e.append(i, t.value);
              }
          }
          _updateFilesUploadProgress(e, t, i) {
            if (e[0].upload.chunked) {
              ...
              for (let e = 0; e < a.upload.totalChunkCount; e++)
                a.upload.chunks[e] &&
                  void 0 !== a.upload.chunks[e].progress &&
                  ((a.upload.progress += a.upload.chunks[e].progress),
                  (a.upload.total += a.upload.chunks[e].total),
                  (a.upload.bytesSent += a.upload.chunks[e].bytesSent));
              (a.upload.progress =
                a.upload.progress / a.upload.totalChunkCount),
                this.emit(
                  "uploadprogress",
                  a,
                  a.upload.progress,
              ...
              this._updateFilesUploadProgress(e, t),
                200 <= t.status && t.status < 300
                  ? e[0].upload.chunked
                    ...
                    : this._finished(e, a, i)
                  : this._handleUploadError(e, t, a);
            }
          }
          ...
          constructor(e, t) {
            ...
            if (
              ((this.options = (0, Lt.A)(!0, {}, xt, s, null != t ? t : {})),
              (this.options.previewTemplate =
                this.options.previewTemplate.replace(/\n*/g, "")),
              this.options.forceFallback || !Ft.isBrowserSupported())
            )
            ...
            this.options.acceptedMimeTypes &&
              ...
              !1 !== this.options.previewsContainer &&
                (this.options.previewsContainer
                  ? (this.previewsContainer = Ft.getElement(
                      this.options.previewsContainer,
                      "previewsContainer"
                    ))
              ...
              this.options.clickable &&
                (!0 === this.options.clickable
                  ...
                  : (this.clickableElements = Ft.getElements(
                      this.options.clickable,
                      "clickable"
                    ))),
              this.init();
        ...
        Ft.initClass(),
          (Ft.options = {}),
          (Ft.optionsForElement = function (e) {
            return e.getAttribute("id")
              ? Ft.options[Zt(e.getAttribute("id"))]
              : void 0;
          }),
          (Ft.instances = []),
          (Ft.forElement = function (e) {
            if (
          ...
          (Ft.isBrowserSupported = function () {
            let e = !0;
            if (
              window.File &&
              window.FileReader &&
              ...
              if ("classList" in document.createElement("a")) {
                void 0 !== Ft.blacklistedBrowsers &&
                  (Ft.blockedBrowsers = Ft.blacklistedBrowsers);
                for (let t of Ft.blockedBrowsers)
        ...
        (Ft.createElement = function (e) {
          ...
          (Ft.getElements = function (e, t) {
            ...
            if (e instanceof Array) {
              ...
              for (i of ((a = []), document.querySelectorAll(e))) a.push(i);
          ...
          (Ft.ADDED = "added"),
          (Ft.QUEUED = "queued"),
          (Ft.ACCEPTED = Ft.QUEUED),
          (Ft.UPLOADING = "uploading"),
          (Ft.PROCESSING = Ft.UPLOADING),
        ...
        const Nt = {
          ...
          Pt = {
            ...
            calendar:
              '<path fill="currentColor" d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-7h18Z" class="duoicon-secondary-layer" opacity=".3"></path><path fill="currentColor" d="M16 3a1 1 0 0 1 1 1v1h2a2 2 0 0 1 2 2v3H3V7a2 2 0 0 1 2-2h2V4a1 1 0 1 1 2 0v1h6V4a1 1 0 0 1 1-1Z" class="duoicon-primary-layer"></path>',
            camera_square:
        ...
        ((e = {}) => {
          if (
            ((e = Object.assign({ icons: {}, attributes: {} }, e)),
        ...
        class qt {
          ...
          constructor(e) {
            (this.options = e),
              ...
              (this.#t = this.#e.dataset.placeholder
                ? this.#e.dataset.placeholder
                : void 0),
              (this.#i = [
          ...
          initEditor() {
            (this.#a = document.createElement("div")),
              ...
              (this.#a.innerHTML = `\n      <div class="popover-body">\n        ${this.#i
                .map(
                  (e) =>
                    `<button class="btn btn-sm btn-link" data-name="${e.name}" data-method="${e.method}" type="button"><span class="material-symbols-outlined">${e.icon}</span></button>`
                )
                .join("")}\n      </div>\n    `),
            ...
            const e = {
                ...
                extensions: [
                  ...
                  Bt.A.configure({ placeholder: this.#t }),
                  Ut.Ay.configure({ element: this.#a, updateDelay: 0 }),
                ],
        ...
        function Gt(e, t, i, a, s, o = 4) {
          const r = Kt.c9.fromISO(e),
            n = Kt.c9.fromISO(t).diff(r, "days").days,
            l = s || n,
            c = [];
          for (let e = 0; e <= l; e++) {
            const t = r.plus({ days: (e / l) * n }).toISODate(),
              s = Wt(e, l, i, a, o);
            c.push({ x: t, y: s });
          }
          return c;
        ...
        Qt &&
          new o.t1(Qt, {
            ...
            data: {
              datasets: [
                { label: "Total", data: Gt("2024-01-01", "2024-01-07", 5, 8) },
                {
                  label: "Tracked",
        ...
        Yt &&
          new o.t1(Yt, {
            ...
            options: {
              ...
              plugins: {
                tooltip: { callbacks: { label: (e) => `${e.parsed.y}hrs` } },
              },
            },
            data: {
              datasets: [
                {
                  label: "Hours worked",
                  data: Gt("2024-01-01", "2024-01-07", 50, 80),
                },
              ],
            },
          });
              ...
              datasets: [
                {
                  ...
                  data: Gt("2024-01-01", "2024-01-31", 25e3, 35e3),
                },
              ],
            },
          });
          document
            .getElementById("cryptoPerformanceChartType")
            .addEventListener("change", (t) => {
              switch (t.target.value) {
                case "trading":
                  (e.data.datasets.label = "Trading profits"),
                    (e.data.datasets[0].data = Gt(
                      "2024-01-01",
                      "2024-01-31",
                      25e3,
                      35e3
        ...
        Jt &&
          new o.t1(Jt, {
            ...
            options: {
              plugins: {
                tooltip: { callbacks: { label: (e) => `${e.raw}%` } },
              },
            },
            data: {
              ...
              datasets: [
                {
                  data: [65, 15, 10, 10],
                  backgroundColor: [
                    `rgba(${r("--bs-primary-rgb")}, 1)`,
                    `rgba(${r("--bs-primary-rgb")}, .5)`,
                    `rgba(${r("--bs-primary-rgb")}, .25)`,
                    `rgba(${r("--bs-primary-rgb")}, .125)`,
                  ],
                },
              ],
            },
        ...
        document
          .querySelectorAll("[data-crypto-currency-success-chart]")
          .forEach((e) => {
            new o.t1(e, {
              type: "line",
              options: {
                scales: {
                  y: { display: !1, beginAtZero: !1 },
                  x: { display: !1 },
                },
                elements: {
                  point: { hoverRadius: 0 },
                ...
                datasets: [
                  {
                    ...
                    data: Gt("2024-01-01", "2024-01-07", 5e3, 5500),
                  },
                ],
              },
            });
        ...
        document
          .querySelectorAll("[data-crypto-currency-danger-chart]")
          .forEach((e) => {
            new o.t1(e, {
              type: "line",
              options: {
          ...
          const e = new o.t1(ei, {
            ...
            data: {
              datasets: [
                {
                  label: "Revenue",
                  data: Gt("2024-01-01", "2024-01-31", 25e3, 35e3, 15),
                },
              ],
            },
          });
          document
            .querySelectorAll("[data-saas-performance-chart-type]")
            .forEach((t) => {
              t.addEventListener("click", (t) => {
                switch (t.target.dataset.saasPerformanceChartType) {
                  case "revenue":
                    (e.options.scales.y.ticks.callback = (e) =>
                      `$${Math.round(e / 1e3)}K`),
                      (e.options.scales.y.ticks.stepSize = 1e4),
                      (e.options.plugins.tooltip.callbacks.label = (e) =>
                        `$${new Intl.NumberFormat("en-EN").format(
                          Math.round(e.parsed.y)
                        )}`),
      ...
      if (!i) {
        ...
        for (h = 0; h < e.length; h++) {
          for (var [i, s, o] = e[h], n = !0, l = 0; l < i.length; l++)
            (!1 & o || r >= o) && Object.keys(a.O).every((e) => a.O[e](i[l]))
              ? i.splice(l--, 1)
              : ((n = !1), o < r && (r = o));
          if (n) {
            e.splice(h--, 1);
